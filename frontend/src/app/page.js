                      ...
                      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-5 space-y-4 relative overflow-hidden">
                        ...
                        <div className="bg-slate-800/70 border border-slate-700/70 rounded-2xl p-4 space-y-3 shadow-inner">
                          ...
                          <div className="space-y-2.5 text-xs font-bold">
                            {[
                              { qty: "1×", item: "Truffle Burger", note: "No Onions" },
                              { qty: "2×", item: "Mango Smoothie", note: null },
                              { qty: "1×", item: "Pasta Arrabbiata", note: "Extra Spicy" },
                            ].map((o, i) => (
                          ...
                          <div className="pt-2 flex gap-2">
                            <button className="flex-1 bg-emerald-500 hover:bg-emerald-400 text-white text-[10px] font-black py-2.5 rounded-xl shadow-lg shadow-emerald-500/20 transition-all active:scale-95">✓ MARK COOKING</button>
                      ...
                      <ul className="space-y-2">
                        {[
                          ...
                          <li key={i} className="flex items-start gap-2 text-[11px] text-slate-600 font-semibold">
                            <span className="w-4 h-4 rounded-full bg-orange-100 text-orange-600 flex items-center justify-center flex-shrink-0 text-[8px] font-black mt-0.5">✓</span>
                            {f}
                          </li>
                        ))}
                      </ul>
          ...
          <div className="bg-white/80 backdrop-blur-md text-slate-800 rounded-3xl p-8 md:p-12 border border-emerald-100 shadow-xl shadow-emerald-500/5 relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 pb-8 border-b border-emerald-100">
              <div className="space-y-3 max-w-2xl">
                ...
                <p className="text-slate-500 text-xs md:text-sm leading-relaxed">
                  While <span className="text-orange-600 font-bold">RESTUVEXO</span> is customized for restaurants and cafes, our parent company <span className="text-slate-700 font-bold">ITVEXO</span> also offers <span className="text-emerald-600 font-bold">POSIX</span> — a dedicated billing software engineered for retail shops, supermarkets, and pharmacies.
                </p>
              </div>
