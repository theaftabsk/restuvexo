...
async function getRestaurantTelemetry(restaurantId: any) {
...
const isNormalQuestion = (message: string) => {
...
const getLocalFallbackResponse = (message: string, telemetry: any, userName: string) => {
  const lowercase = message.toLowerCase();
