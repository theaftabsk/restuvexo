...
// ────────────────────────────────────────────────────────────────
async getRestaurants(req, res: any) {
  if (!checkAdminAuth(req)) return res.status(401).json({ error: "Unauthorized Super Admin Access." });
...
// ────────────────────────────────────────────────────────────────
async getRestaurantById(req, res: any) {
  if (!checkAdminAuth(req)) return res.status(401).json({ error: "Unauthorized Super Admin Access." });
...
// ────────────────────────────────────────────────────────────────
async updateRestaurantSettings(req, res: any) {
  if (!checkAdminAuth(req)) return res.status(401).json({ error: "Unauthorized Super Admin Access." });
...
// ────────────────────────────────────────────────────────────────
async deleteRestaurant(req, res: any) {
  if (!checkAdminAuth(req)) return res.status(401).json({ error: "Unauthorized Super Admin Access." });
...
// ────────────────────────────────────────────────────────────────
async updateDemoRequest(req, res: any) {
  if (!checkAdminAuth(req)) return res.status(401).json({ error: "Unauthorized Super Admin Access." });
...
// DELETE DEMO REQUEST
// ────────────────────────────────────────────────────────────────
async deleteDemoRequest(req, res: any) {
  if (!checkAdminAuth(req)) return res.status(401).json({ error: "Unauthorized Super Admin Access." });
