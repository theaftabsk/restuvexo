...
export class DashboardService {
  constructor(private prisma: PrismaService, private settingsService: SettingsService, private websocketGateway: WebsocketGateway) {
...
async getDashboardStats(req, res: any) {
  ...
  try {
    ...
    // Calculate 7-day sales breakdown
    ...
    // Send complete compiled report with normalized properties
    res.json({
...
async getSidebarTelemetry(req, res: any) {
...
async broadcastSidebarTelemetry(restaurantId: any) {
  try {
