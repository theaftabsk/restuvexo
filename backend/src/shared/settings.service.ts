...
export class SettingsService {
  ...
  async getRestaurantSettings(restaurantId: number) {
    ...
    // Sync new RestaurantSubscription state to settings flat fields for backwards compatibility
    try {
   ...
   */
  async updateRestaurantSettings(restaurantId: number, updateData: any) {
