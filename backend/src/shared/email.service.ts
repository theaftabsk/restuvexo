...
// ─── SVG Icon & Vector Graphic Helpers (Email Client Bulletproof) ────────────
const svgLockShield = () => `
...
// ─── Shared Anti-Spam Compliant Footer ──────────────────────────────────────
...
export class EmailService {
  ...
  // Pure Nodemailer SMTP Dispatch Engine with 100% Anti-Spam Headers
  private async dispatchEmail(
    ...
    // Anti-Spam / High Priority Transactional Headers
    ...
    // 2. Dev / Sandbox Logging Mode
    console.log(`[Email Sandbox] Email logged for ${to}: ${subject}`);
    return true;
  }

  // 1. OTP Verification Email (100% Anti-Spam Delivery & Premium Responsive Design)
...
© 2026 RESTUVEXO Inc. • https://restuvexo.shop
    ...
    return this.dispatchEmail(
      email,
      `[RESTUVEXO] ${otp} is your verification code`,
      htmlContent,
      plainText
    );
  }
  ...
  async sendResetPasswordEmail(email: string, name: string, resetLink: string): Promise<boolean> {
    console.log(`\n======================================================`);
...
© 2026 RESTUVEXO Inc.
    ...
    return this.dispatchEmail(
      email,
      `[RESTUVEXO] Password Reset Request`,
      htmlContent,
      plainText
    );
  }
  ...
  // 3. Welcome Email
  async sendWelcomeEmail(email: string, name: string, restaurantName: string): Promise<boolean> {
    console.log(`\n======================================================`);
...
© 2026 RESTUVEXO Inc.
    ...
    return this.dispatchEmail(
      email,
      `Welcome to RESTUVEXO — ${restaurantName} is Live!`,
      htmlContent,
      plainText
    );
  }
